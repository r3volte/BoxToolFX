...
public class DatabaseFileRead {
  ...
  public void databaseConfReader(String fileIn, Map<String, Box> list, Type type) throws FileNotFoundException {
    HashMap<String, Box> tempList = new Gson().fromJson(readFile(fileIn), type);
