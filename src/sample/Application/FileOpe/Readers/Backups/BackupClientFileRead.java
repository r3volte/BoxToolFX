package sample.Application.FileOpe.Readers.Backups;
...
public class BackupClientFileRead implements FileRead {

  private Gson gson = new Gson();
  private static final Logger logger = Logger.getLogger(BackupClientFileRead.class.getName());
